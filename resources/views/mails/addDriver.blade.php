<!DOCTYPE html xmlns="http://www.w3.org/1999/xhtml">
		...
		<table width="600" style="display:block;background-color:#158da5;" border="0" align="center" cellpadding="0" cellspacing="0">
		  ...
		  <tr>
		    <td align="center" valign="top" bgcolor="#158da5" style="background-color:#fff; font-family:Arial, Helvetica, sans-serif; font-size:13px; color:#000000; padding: 9%;"><table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:10px;">
		        <tr>
		          ...
		          <!-- <div style="font-family:Georgia, Times New Roman, Times, serif; font-weight:600;font-size:25px; color:#000;">Welcome to {{env('APP_NAME')}}<span style="color:#478730;"></span></div> -->
		            <div>
		            <img src="{{env('APP_URL').'/'.$logo}}" align="right" style="margin-left:10px;width:75px;height:75px;" class="CToWUd a6T" tabindex="0">
		              <p style="font-family:Georgia, Times New Roman, Times, serif; font-weight:600;font-size:20px; color:#000;">Dear User,</p>
		  ...
		  <tr>
		    <td nowrap align="left" valign="top" bgcolor="#478730" style="background-color:#158da5;"><table width="100%" border="0" cellspacing="0" cellpadding="15">
		      <tr>
		        <td nowrap align="left" valign="top" style="color:#ffffff; font-family:Arial, Helvetica, sans-serif; font-size:11px;">
		        <div class="row">
							Email:<a href={{$email_to}} target="_blank" style="color:#ffffff; text-decoration:none;">{{$admin_mail}}</a>
							</div>
							<div class="row">

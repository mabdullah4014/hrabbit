<html xmlns="http://www.w3.org/1999/xhtml">
            ...
            <title>{{env('APP_NAME')}}-Trip Start OTP</title>
            </head>
            ...
            <table width="600" style="display:block;background-color:#158da5;" border="0" align="center" cellpadding="0" cellspacing="0">
                ...
                <p style="font-family:Georgia, Times New Roman, Times, serif; font-weight:600;font-size:20px; color:#000;">Dear {{$customer_name}},</p>
               {!!$content!!} <b>Trip OTP : {{$otp}}</b>
                </div></td>
                </tr>
                </table></td>
                </tr>

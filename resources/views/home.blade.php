                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                            <ul class="nav navbar-nav">
                                <li>
                                    <a href="" style="margin-left:-70px;">vCabb</a>
                                </li>
                                <!-- <li>
                                    <a href="">Drive</a>
                                </li>
...
<div class="row white-section pad-60">
    <div class="container">
        ...
        <div class="col-md-6">
            ...
            <p>vCabb is the smartest way to get around. One tap and a car comes directly to you. Your driver knows exactly where to go. And you can pay with either cash or card.</p>
...
<div class="row gray-section pad-60">
    <div class="container">
        <div class="col-md-6">
            ...
            <div class="title-divider"></div>
            <p>Daily commute. Errand across town. Early morning flight. Late night drinks. Wherever you’re headed, count on vCabb for a ride—no reservations needed.</p>
            <a class="content-more more-btn" href="">MORE REASONS TO RIDE <i class="fa fa-chevron-right"></i></a>
        </div>
    </div>
        <div class="col-md-6 img-box text-center">
...
<div class="row white-section pad-60">
    <div class="container">
        ...
        <div class="col-md-6 content-block">
            ...
            <div class="title-divider"></div>
            <p>You can always request everyday cars at everyday prices. But sometimes you need a bit more space. Or you want to go big on style. With vCabb, the choice is yours.</p>
            <a class="content-more more-btn" href="">MORE REASONS TO RIDE <i class="fa fa-chevron-right"></i></a>
        </div>
    </div>
</div>
...
<div class="row white-section pad-60 ">
    <div class="container">
        ...
        <div class="col-md-6 content-block">
            ...
            <div class="title-divider"></div>
            <p>A city with vCabb has more economic opportunities for residents, fewer drunk drivers on the streets, and better access to transportation for those without it.</p>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>vCabb is available in your city</p>
      </div>

    ...
    <div class="row">
        <div class="col-md-3 col-md-offset-3">
            ...
            <div class="col-md-3">
             <div class="row no-margin fields banner-ride-drive">
                    <div class="left">
                        <img src="{{asset('images/taxi-car.png')}}">
                    </div>
                    <div class="right">
                        <a href="">
...
<div class="row white-section pad-60">
    <div class="container">
        <div class="col-md-6 img-box text-center">
            <img src="{{asset('images/screen-bg.png')}}">
        </div>
        <div class="col-md-6">
             <div class="content-block">
              <div class="icon"><img src="{{asset('images/taxi-app.png')}}"></div>
            <h2>Tap the app, get a ride</h2>
            <div class="title-divider"></div>
            <p>Houston Rabbit is the smartest way to get around. One tap and a car comes directly to you. Your driver knows exactly where to go. And you can pay with either cash or card.</p>
            <a class="content-more more-btn" href="">MORE REASONS TO RIDE <i class="fa fa-chevron-right"></i></a>
        </div>
    </div>
    </div>
</div>
...
<div class="row gray-section pad-60">
    <div class="container">
        <div class="col-md-6">
            <div class="content-block">
            <div class="icon"><img src="{{asset('images/destination.png')}}"></div>
            <h2>Ready anywhere, anytime</h2>
            <div class="title-divider"></div>
            <p>Daily commute. Errand across town. Early morning flight. Late night drinks. Wherever you’re headed, count on Houston Rabbit for a ride—no reservations needed.</p>
            <a class="content-more more-btn" href="">MORE REASONS TO RIDE <i class="fa fa-chevron-right"></i></a>
        </div>
    </div>
        <div class="col-md-6 img-box text-center">
            <img src="{{asset('images/screen-bg-3.png')}}">
        </div>
    </div>
</div>
...
<div class="row white-section pad-60">
    <div class="container">
        <div class="col-md-6 img-box text-center">
            <img src="{{asset('images/screen-bg-4.png')}}">
        </div>
        <div class="col-md-6 content-block">
              <div class="icon"><img src="{{asset('images/budget.png')}}"></div>
            <h2>Low-cost to luxury</h2>
            <div class="title-divider"></div>
            <p>You can always request everyday cars at everyday prices. But sometimes you need a bit more space. Or you want to go big on style. With Houston Rabbit, the choice is yours.</p>
            <a class="content-more more-btn" href="">MORE REASONS TO RIDE <i class="fa fa-chevron-right"></i></a>
        </div>
    </div>
</div>
...
<div class="row gray-section pad-60 full-section">
    <div class="container">
        <div class="col-md-6 content-block">
              <div class="icon"><img src="{{asset('images/car-wheel.png')}}"></div>
            <h5>Behind the Wheel</h5>
            <h2>They’re people like you, going your way</h2>
            <div class="title-divider"></div>
            <p>What makes the Houston Rabbit experience truly great are the people behind the wheel. They are mothers and fathers. Students and teachers. Veterans. Neighbors. Friends. Our partners drive their own cars—on their own schedule—in cities big and small. Which is why more than one million people worldwide have signed up to drive.</p>
            <a class="content-more more-btn" href="">WHY DRIVE WITH Houston Rabbit <i class="fa fa-chevron-right"></i></a>
        </div>
...
<div class="row white-section pad-60 ">
    <div class="container">
        <div class="col-md-6 img-box text-center">
            <img src="{{asset('images/cost-cities.png')}}">
        </div>
        <div class="col-md-6 content-block">
              <div class="icon"><img src="{{asset('images/taxi-location.png')}}"></div>
            <h2>Helping Cities For the good of all</h2>
            <div class="title-divider"></div>
            <p>A city with Houston Rabbit has more economic opportunities for residents, fewer drunk drivers on the streets, and better access to transportation for those without it.</p>
            <a class="content-more more-btn" href="">OUR LOCAL IMPACT <i class="fa fa-chevron-right"></i></a>
        </div>
    </div>
</div>
...
<div class="row gray-section pad-60 full-section">
    <div class="container">
        <div class="col-md-6 content-block">
              <div class="icon"><img src="{{asset('images/seat-belt.png')}}"></div>
            <h2>Safety Putting people first</h2>
            <div class="title-divider"></div>
            <p>Whether riding in the backseat or driving up front, every part of the Houston Rabbit experience has been designed around your safety and security.</p>
...
<div class="row find-city">
    <div class="container pad-60 content-block center">
        <h2>Houston Rabbit is in Your City</h2>
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
        <form>
            <div class="input-group find-form">
                <input type="text" class="form-control pac-target-input" placeholder="Search" id="origin-input" autocomplete="off">
                <div id="map" style="display: none; position: relative; overflow: hidden;"><div style="height: 100%; width: 100%; position: absolute; top: 0px; left: 0px; background-color: rgb(229, 227, 223);"><div style="overflow: hidden;"></div><div class="gm-style" style="position: absolute; z-index: 0; left: 0px; top: 0px; height: 100%; width: 100%; padding: 0px; border-width: 0px; margin: 0px;"><div tabindex="0" style="position: absolute; z-index: 0; left: 0px; top: 0px; height: 100%; width: 100%; padding: 0px; border-width: 0px; margin: 0px; cursor: url(&quot;https://maps.gstatic.com/mapfiles/openhand_8_8.cur&quot;), default; touch-action: pan-x pan-y;"><div style="z-index: 1; position: absolute; left: 50%; top: 50%; width: 100%; transform: translate(0px, 0px);"><div style="position: absolute; left: 0px; top: 0px; z-index: 100; width: 100%;"><div style="position: absolute; left: 0px; top: 0px; z-index: 0;"><div style="position: absolute; z-index: 988; transform: matrix(1, 0, 0, 1, -200, -192);"><div style="position: absolute; left: 0px; top: 0px; width: 256px; height: 256px;"><div style="width: 256px; height: 256px;"></div></div></div></div></div><div style="position: absolute; left: 0px; top: 0px; z-index: 101; width: 100%;"></div><div style="position: absolute; left: 0px; top: 0px; z-index: 102; width: 100%;"></div><div style="position: absolute; left: 0px; top: 0px; z-index: 103; width: 100%;"><div style="position: absolute; left: 0px; top: 0px; z-index: -1;"><div style="position: absolute; z-index: 988; transform: matrix(1, 0, 0, 1, -200, -192);"><div style="width: 256px; height: 256px; overflow: hidden; position: absolute; left: 0px; top: 0px;"></div></div></div></div><div style="position: absolute; left: 0px; top: 0px; z-index: 0;"></div></div><div class="gm-style-pbc" style="z-index: 2; position: absolute; height: 100%; width: 100%; padding: 0px; border-width: 0px; margin: 0px; left: 0px; top: 0px; opacity: 0;"><p class="gm-style-pbt"></p></div><div style="z-index: 3; position: absolute; height: 100%; width: 100%; padding: 0px; border-width: 0px; margin: 0px; left: 0px; top: 0px; touch-action: pan-x pan-y;"><div style="z-index: 4; position: absolute; left: 50%; top: 50%; width: 100%; transform: translate(0px, 0px);"><div style="position: absolute; left: 0px; top: 0px; z-index: 104; width: 100%;"></div><div style="position: absolute; left: 0px; top: 0px; z-index: 105; width: 100%;"></div><div style="position: absolute; left: 0px; top: 0px; z-index: 106; width: 100%;"></div><div style="position: absolute; left: 0px; top: 0px; z-index: 107; width: 100%;"></div></div></div></div><iframe aria-hidden="true" frameborder="0" tabindex="-1" style="z-index: -1; position: absolute; width: 100%; height: 100%; top: 0px; left: 0px; border: none;"></iframe></div></div></div>
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-2 col-md-offset-1 support">
                 ...
                 <div class="col-xs-12 col-sm-12  col-md-6 sup-txt"><h2>For Support?     Call Us</h2>
                     <div class="call-num">
<h3 class=""><a href="tel:13053519479">13053519479</a> </h3>
                </div>
             </div>
    ...
    <div class="container pad-60" "="">
        <div class="row center">
            ...
            <img src="{{asset('images/user-appstore.png')}}">
                                        </a>
                                    </div>
                                    <div class="col-md-6">
                 <a target="_blank" href="">
            <img src="{{asset('images/user-playstore.png')}}">
                                        </a>
                                    </div>
              </div>
           ...
           <div class="col-md-6">
              <div class="">
                 <div class="col-md-6">
                 <a target="_blank" href="">
            <img src="{{asset('images/provider-appstore.png')}}">
                                        </a>
                                    </div>
                                    <div class="col-md-6">
                 <a target="_blank" href="">
            <img src="{{asset('images/provider-playstore.png')}}">
                                        </a>
                                    </div>
              </div>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>Houston Rabbit is available in your city</p>
      </div>
    ...
    <script type="text/javascript" charset="UTF-8" src="{{asset('js/web/common.js')}}"></script>
<script type="text/javascript" charset="UTF-8" src="{{asset('js/web/util.js')}}"></script>
<script type="text/javascript" charset="UTF-8" src="{{asset('js/web/map.js')}}"></script>
<script type="text/javascript" charset="UTF-8" src="{{asset('js/web/geometry.js')}}"></script>
<script type="text/javascript" charset="UTF-8" src="{{asset('js/web/poly.js')}}"></script><script type="text/javascript" charset="UTF-8" src="{{asset('js/web/directions.js')}}"></script>
<script type="text/javascript" charset="UTF-8" src="{{asset('js/web/controls.js')}}"></script>
<script type="text/javascript" charset="UTF-8" src="{{asset('js/web/places_impl.js')}}"></script>
<script type="text/javascript" charset="UTF-8" src="{{asset('js/web/stats.js')}}"></script>
<script type="text/javascript" charset="UTF-8" src="{{asset('js/web/onion.js')}}"></script>
<script type="text/javascript" charset="UTF-8" src="{{asset('js/web/infowindow.js')}}"></script>
<script type="text/javascript" charset="UTF-8" src="{{asset('js/web/marker.js')}}"></script>
...
<script src="{{asset('js/web/scripts.js')}}"></script>
    ...
    <script>
        ...
        <script type="text/javascript" src="{{asset('js/web/map(1).js')}}"></script>
<script src="{{asset('js/web/js')}}" async="" defer=""></script>
...
<script src="{{asset('js/web/jquery.min(1).js')}}"></script>
<script type="text/javascript">
...
<div class="pac-container pac-logo" style="display: none;"></div><div class="pac-container pac-logo" style="display: none;"></div></body></html>
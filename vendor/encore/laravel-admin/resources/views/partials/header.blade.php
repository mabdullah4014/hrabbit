...
<header class="main-header">
    ...
    <a href="{{ admin_base_path('/') }}" class="logo">
        <!-- mini logo for sidebar mini 50x50 pixels {!! config('admin.logo-mini', config('admin.name')) !!} -->
        <span class="logo-mini">HR</span>
        <!-- logo for regular state and mobile devices {!! config('admin.logo', config('admin.name')) !!} -->
